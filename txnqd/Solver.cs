...
namespace txnqd
{
    public class Solver
    {
        ...
        {
            translateScrambleToArrayState(scramble);
            CenterOrient();
            ...
            else
            {
                ...
                if (checkFinished() == true)
                {
                    ...
                    c.corners = corners;
                    c.edges = edges;
                    List<string> result = Search.patternSolve(c, TwoPhaseSolver.Move.None, 30, printInfo: true);
                    return "Phase 1: " + result[0] + "\nPhase 2: " + result[1];
                }
                else
                {
        ...
        public string OneLineSolve(string scramble)
        {
            translateScrambleToArrayState(scramble);
            CenterOrient();
            BindingStateForKociembaCube();
        ...
        public void Solve(ref Colors[] myCube)
        {
            doCross(ref myCube);
            doLayer2(ref myCube);
            TopCross(ref myCube);
        ...
        public void translateScrambleToArrayState(string scramble)
        {
            //states = "430502052213215530033320104403431115541441222144552305";
